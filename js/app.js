  ...
  questions: [
    {
      ...
      choices: ["Colorful Style Sheets", "Computer Style Sheets", "Creative Style Sheets", "Cascading Styles Sheets"],
      correctChoiceIndex: 3
    },
    {
      text: "Which CSS property control text size?",
      choices: ["font-style", "text-size", "font-size", "text-style"],
      correctChoiceIndex: 2
    },
    {
      text: "How do you select element with id 'demo'?",
      choices: ["#demo", ".demo", "demo", "*demo"],
      correctChoiceIndex: 0,
    },
    {
      text: "How do you select elements with class name 'test'?",
      choices: ["#text", ".text", "test", "*test"],
